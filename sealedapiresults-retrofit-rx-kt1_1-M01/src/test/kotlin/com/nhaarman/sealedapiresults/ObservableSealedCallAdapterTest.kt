...
internal class ObservableSealedCallAdapterTest {

    val successResult = "test"

    lateinit var mAdapter: ObservableSealedCallAdapter

    @Before
    fun setup() {
        mAdapter = ObservableSealedCallAdapter(String::class.java)
    }
    ...
    fun cancelled() {
        ...
        val adapter = ObservableSealedCallAdapter(String::class.java, scheduler)
